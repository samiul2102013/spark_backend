...
urlpatterns = [
    ...
    path("hazards/<int:hazard_id>/comments/", views.hazard_comment_list_view, name="hazard-comment-list"),
    path("hazards/<int:hazard_id>/comments/create/", views.hazard_comment_create_view, name="hazard-comment-create"),
]
