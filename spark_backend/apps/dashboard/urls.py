...
urlpatterns = [
    ...
    path(
        ...
        views.DashboardInfrastructureView.as_view(),
        name="dashboard-infrastructure",
    ),
    path(
        "dashboard/infrastructure/<int:hub_id>/",
        views.DashboardInfrastructureDetailView.as_view(),
        name="dashboard-infrastructure-detail",
    ),
]
