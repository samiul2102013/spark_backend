...
class SparkBaseException(Exception):
...
def custom_exception_handler(exc, context):
    if isinstance(exc, SparkBaseException):
        return Response(
            {
                "status": "error",
                "data": None,
